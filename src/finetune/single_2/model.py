...
class VLModel(nn.Module):
    def __init__(self, args,is_test=False):
        super().__init__()
        if is_test != True:
            pretrain_state = torch.load('/home/tione/notebook/env/code/pretrain/single_stream/1_xxx(plan name)/checkpoint/model_epoch_9_step_229160_total_loss_ 4.757.pth', map_location='cpu')
