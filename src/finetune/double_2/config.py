...
config = {
    ...
    #============================clip vit/16===========================
    "clip_vit_dir":"/home/tione/notebook/env/code/finetune/double_stream/21_测离线fp16_vit/inference_model/ViT-B-16.pt",
    ...
    'freeze_bert_layer':6,
    'fold':10,
    'pretrained_model_path':'/home/tione/notebook/env/code/pretrain/double_stream/5_4has_restore_720ensamble_不要动了/4_meter_clipvit_pretrain/checkpoint/model_epoch_4_step_68750_total_loss_ 6.262.pth'
}
