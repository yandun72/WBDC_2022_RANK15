...
class MultiModalDataset(Dataset):
    ...
    def __init__(self,args,data,test_mode=False):
        ...
        self.zip_feat_path = args.train_zip_frames
        if test_mode == False:
...
#     def __init__(self,args,data,device,test_mode=False):
#         self.max_frame = args.max_frames
#         self.test_mode=test_mode
#         self.bert_seq_length = args.bert_seq_length
#         self.device = device
#         self.num_workers = args.num_workers
#         self.train_zip_frames = args.train_zip_frames
#         self.unlabeld_zip_frames = args.unlabeld_zip_frames
...
#         is_train = self.is_train[idx]
#         if is_train == True:
#             zip_path = os.path.join(self.train_zip_frames, f'{vid[-3:]}/{vid}.zip')
#         else:
#             zip_path = os.path.join(self.unlabeld_zip_frames, f'{vid[-3:]}/{vid}.zip')
        
#         if self.is_train == False:
#             zip_path = zip_path.replace('unlabeled/','')
