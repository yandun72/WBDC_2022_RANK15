...
config = {
    ...
    "train_zip_feats": '../../Vit_B_16_unlabeled_zip_feats/',
    ...
    "unlabeld_annotation":'/opt/ml/input/data/annotations/unlabeled.json',
    "unlabeld_zip_frames":'../../Vit_B_16_unlabeled_zip_feats/',
    "val_ratio": 0.1,  # 验证集大小
    "batch_size": 32,
    "accumlate_step":1,
    "val_batch_size": 50,
