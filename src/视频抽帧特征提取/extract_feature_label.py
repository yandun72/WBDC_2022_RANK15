...
class Config():
    def __init__(self):
        self.zip_frame_dir = '/opt/ml/input/data/zip_frames/labeled'
        self.ann_path = '/opt/ml/input/data/annotations/labeled.json'
        
        self.output_path_0 = '../Vit_B_16_unlabeled_zip_feats/labeled_0.zip'
        self.output_path_1 = '../Vit_B_16_unlabeled_zip_feats/labeled_1.zip'
